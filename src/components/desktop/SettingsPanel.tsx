...
// The compression-settings form, extracted from the /desktop/settings route
// so it can render BOTH as that route AND inside a modal opened from the
// topbar. The modal matters because tweaking settings mid-task (e.g. flipping
// to "HDR JPEG" while picking photos) used to navigate to the settings route,
// which unmounted the new-album/add page and wiped the in-progress draft.
// Settings persist to localStorage, so route vs modal makes no difference to
// persistence — it's purely about not unmounting the page underneath.
